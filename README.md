...
<!--   <img
  src="https://cr-skills-chart-widget.azurewebsites.net/api/api?username=abenkoula71&width=820&style=--axis-bg-color:rgba(0,%0,%0,%0.0);"
/> -->
  
  <img
  src="https://cr-ss-service.azurewebsites.net/api/ScreenShot?widget=education&username=abenkoula71&max-items=2&certificates=false&style=--item-bg-color:%23f00;--item-border-radius:10px"
/>
